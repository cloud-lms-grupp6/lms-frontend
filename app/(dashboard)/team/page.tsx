      ...
      <div className="flex-1 rounded-card bg-card p-6 shadow-sm flex flex-col items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center max-w-sm text-center gap-4">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-xl font-bold text-foreground">No Teams Joined</h2>
            <p className="text-xs text-muted-foreground leading-relaxed">
              You are not assigned to any project team yet. Collaborative workspaces will load here once groups are assigned.
            </p>
          </div>
        </div>
      </div>
